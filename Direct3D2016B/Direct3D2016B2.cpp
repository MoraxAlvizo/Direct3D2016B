...
Comments:
	...
	User    DD/MM/AA - Coment
	OMAR	10/09/16 - Issue 6545 Done!-
	ANDRES  10/19/16 - Issue add func 
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
		...
		g_World = Identity();
		{
			...
			if (!g_pSRVCubeMap)
			{
				DirectX::CreateDDSTextureFromFile(g_Manager.GetDevice(), L"..\\Assets\\grasscube1024.dds", NULL, &g_pSRVCubeMap);
			}
		}
