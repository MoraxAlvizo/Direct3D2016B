...
enum JOY_EVENTS
{
 ...
 JOY_AXIS_LX_LEFT_PRESSED,
 JOY_AXIS_LX_LEFT_RELEASED,
 JOY_AXIS_LX_RIGHT_PRESSED,
 JOY_AXIS_LX_RIGHT_RELEASED,
 JOY_AXIS_LY_UP_PRESSED,
 JOY_AXIS_LY_UP_RELEASED,
 JOY_AXIS_LY_DOWN_PRESSED,
 JOY_AXIS_LY_DOWN_RELEASED
